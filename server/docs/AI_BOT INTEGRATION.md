...
3. **CRITICAL:** Include the `x-api-key` header in your request, or the server will reject it. *(Note: The API key is restricted and will be provided upon request by the system administrator).*
